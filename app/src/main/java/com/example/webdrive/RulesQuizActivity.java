...
public class RulesQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rules_quiz);
            ...
            if (isclickBtn) {
                ...
                new Handler().postDelayed(() -> {
                    if (currentQuestion != question_list.length - 1) {
                        ...
                        Intent intent = new Intent(RulesQuizActivity.this, ResultActivity.class);
                        intent.putExtra("Result", correctCount);
                        startActivity(intent);
                    }
                }, 2000);
            } else {
                Toast.makeText(RulesQuizActivity.this, "You have to choose one", Toast.LENGTH_LONG).show();
            }
        });
    }
